namespace HostApp
{
	 ...
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, bool, abort_operation, abort_operation)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, Sketchup::Entities, active_entities, active_entities)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, Sketchup::Layer, active_layer, active_layer)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, Sketchup::Layer, set_active_layer, (Sketchup::Layer layer), active_layer =, layer)
	 ...
	 */
	inline RubyUtils::Enumerable<Sketchup::Drawingelement> Sketchup::Model::active_path()
	{
		auto obj = this->_send<IObject>("active_path");
		if (obj.is_nil())
		{
			return RubyUtils::Enumerable<Sketchup::Drawingelement>({});
		}
		return RubyUtils::Enumerable<Sketchup::Drawingelement>(obj);
	}
	 ...
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, Sketchup::Model, set_active_path, (Sketchup::InstancePath instance_path), active_path =, instance_path)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, Sketchup::View, active_view, active_view)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, Sketchup::Text, add_note, (std::string note, double x, double y), add_note, note, x, y)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, bool, add_observer, (Sketchup::ModelObserver observer), add_observer, observer)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, Sketchup::AttributeDictionaries, attribute_dictionaries, attribute_dictionaries)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, RubyUtils::optional<Sketchup::AttributeDictionary>, attribute_dictionary, (std::string name, bool create), attribute_dictionary, name, create)
	 ...
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, Sketchup::Axes, axes, axes)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, Sketchup::Behavior, behavior, behavior)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, Geom::BoundingBox, bounds, bounds)
	 ...
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, Sketchup::Classifications, classifications, classifications)
	 ...
	 * @min_version SketchUp 2015
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, void, close, (bool ignore_changes), close, ignore_changes)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, bool, close_active, close_active)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, bool, commit_operation, commit_operation)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, Sketchup::DefinitionList, definitions, definitions)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, std::string, description, description)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, std::string, set_description, (std::string description), description =, description)
	 ...
	 * @min_version SketchUp 2020.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, bool, is_drawing_element_visible, (Sketchup::InstancePath instance_path), drawing_element_visible?, instance_path)
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, bool, is_drawing_element_visible, (RubyUtils::Enumerable<Sketchup::Drawingelement> instance_path), drawing_element_visible?, instance_path)
	 ...
	 * @min_version SketchUp 7.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, Geom::Transformation, edit_transform, edit_transform)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, Sketchup::Entities, entities, entities)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, bool, export_, (std::string path, Sketchup::ExportOptions options), export, path, options)
	 ...
	 * @min_version
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, bool, export_, (std::string path, bool show_summary), export, path, show_summary)
	 ...
	 * @min_version SketchUp 2015
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, RubyUtils::Enumerable<RubyUtils::optional<Sketchup::Entity>>, find_entity_by_id, (RubyUtils::Enumerable<long long> ids_or_array), find_entity_by_id, ids_or_array)
	 ...
	 * @min_version
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, RubyUtils::optional<Sketchup::Entity>, find_entity_by_persistent_id, (long long ids_or_array), find_entity_by_persistent_id, ids_or_array)
	 ...
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, RubyUtils::Enumerable<RubyUtils::optional<Sketchup::Entity>>,find_entity_by_persistent_id, (RubyUtils::Enumerable<long long> ids_or_array, FindEntityByPersistentIdScope scope), find_entity_by_persistent_id, ids_or_array, scope)
	 ...
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, bool, is_georeferenced, georeferenced?)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, RubyUtils::optional<RubyUtils::details::IObject>, get_attribute, (std::string dictname, std::string key, RubyUtils::details::IObject defaultvalue), get_attribute, dictname, key, defaultvalue)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, std::string, get_datum, get_datum)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, long long, get_product_family, get_product_family)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, std::string, guid, guid)
	 ...
	 * @min_version
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, bool, import_, (std::string path, ImportOptions options), import, path, options)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, bool, import_, (std::string path, bool show_summary), import, path, show_summary)
	 ...
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, Sketchup::InstancePath, instance_path_from_pid_path, (std::string pid_path), instance_path_from_pid_path, pid_path)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, Geom::Point3d, latlong_to_point, (RubyUtils::Enumerable<RubyUtils::tuple<double DEFINE_WRAPPED_METHOD_COMMA double>> lnglat_array), latlong_to_point, lnglat_array)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, Sketchup::Layers, layers, layers)
	 ...
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, Sketchup::LineStyles, line_styles, line_styles)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, RubyUtils::Enumerable<std::string>, list_datums, list_datums)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, Sketchup::Materials, materials, materials)
	 ...
	 * @min_version SketchUp 7.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, bool, set_mipmapping, (bool mipmap), mipmapping =, mipmap)
	 ...
	 * @min_version SketchUp 7.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, bool, is_mipmapping, mipmapping?)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, bool, is_modified, modified?)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, std::string, name, name)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, RubyUtils::details::IObject, set_name, (std::string name), name =, name)
	 ...
	 * @min_version SketchUp 7.1
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, long long, number_faces, number_faces)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, Sketchup::OptionsManager, options, options)
	 ...
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, Sketchup::OverlaysManager, overlays, overlays)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, Sketchup::Pages, pages, pages)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, std::string, path, path)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, RubyUtils::optional<Sketchup::Model>, place_component, (Sketchup::ComponentDefinition componentdef, bool repeat), place_component, componentdef, repeat)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, RubyUtils::details::IObject, point_to_latlong, (Geom::Point3d point), point_to_latlong, point)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, Geom::UTM, point_to_utm, (Geom::Point3d point), point_to_utm, point)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, RubyUtils::optional<RubyUtils::Enumerable<RubyUtils::tuple<Geom::Point3d DEFINE_WRAPPED_METHOD_COMMA Geom::Vector3d>>>, raytest, (RubyUtils::Enumerable<RubyUtils::tuple<Geom::Point3d, Geom::Vector3d>> ray, bool wysiwyg_flag), raytest, ray, wysiwyg_flag)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, bool, remove_observer, (Sketchup::ModelObserver observer), remove_observer, observer)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, Sketchup::RenderingOptions, rendering_options, rendering_options)
	 ...
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, bool, save, save)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, bool, save, (std::string path), save, path)
	 ...
	 * @min_version SketchUp 2014
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, bool, save, (std::string path, _VERSION version), save, path, (int)version)
	 ...
	 * @min_version SketchUp 2014
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, bool, save_copy, (std::string path, _VERSION version), save_copy, path, (int)version)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, bool, save_thumbnail, (std::string filename), save_thumbnail, filename)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, Sketchup::Model, select_tool, (RubyUtils::details::IObject tool), select_tool, tool)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, Sketchup::Selection, selection, selection)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, RubyUtils::details::IObject, set_attribute, (std::string attrdictname, std::string key, RubyUtils::details::IObject value), set_attribute, attrdictname, key, value)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, void, set_datum, (std::string datum), set_datum, datum)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, Sketchup::ShadowInfo, shadow_info, shadow_info)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, bool, start_operation, (std::string op_name, bool disable_ui, bool next_transparent, bool transparent), start_operation, op_name, disable_ui, next_transparent, transparent, transparent)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, Sketchup::Styles, styles, styles)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, std::string, tags, tags)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, std::string, set_tags, (std::string tags), tags =, tags)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, std::string, title, title)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, Sketchup::Tools, tools, tools)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD(Sketchup::Model, Geom::Point3d, utm_to_point, (Geom::UTM utm), utm_to_point, utm)
	 ...
	 * @min_version SketchUp 6.0
	 */
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::Model, bool, is_valid, valid?)

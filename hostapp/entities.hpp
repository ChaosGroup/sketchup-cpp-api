...
class Entities : public RubyUtils::Enumerable<Sketchup::Entity>, public RubyUtils::details::NamedRubyWrapper<"Sketchup::Entities">
{
	public:
	inline Entities(VALUE obj);
	inline Entities(const Entities& obj);
	 ...
	 */
	DEFINE_WRAPPED_METHOD(RubyUtils::optional<Sketchup::Entity>, operator[], (long long entity_index), [], entity_index)
	 ...
	 */
	DEFINE_WRAPPED_METHOD_0(RubyUtils::optional<Sketchup::SectionPlane>, active_section_plane, active_section_plane)
	 ...
	 * @min_version SketchUp 2014
	 */
	DEFINE_WRAPPED_METHOD(RubyUtils::optional<Sketchup::SectionPlane>, set_active_section_plane, (RubyUtils::optional<Sketchup::SectionPlane> sec_plane), active_section_plane=, sec_plane)
	 ...
	 * @min_version SketchUp 6.0
	 */
	DEFINE_WRAPPED_METHOD(bool, add_3d_text, (std::string string, long long alignment, std::string font, bool is_bold = false, bool is_italic = false, Length letter_height = 1.0, double tolerance = 0.0, Length z = 0.0, bool is_filled = true, Length extrusion = 0.0), add_3d_text, string, alignment, font, is_bold, is_italic, letter_height, tolerance, z, is_filled, extrusion)
	 ...
	 * @min_version
	 */
	DEFINE_WRAPPED_METHOD(RubyUtils::Enumerable<Sketchup::Edge>, add_arc, (Geom::Point3d center, Geom::Vector3d xaxis, Geom::Vector3d normal, double radius, double start_angle, double end_angle), add_arc, center, xaxis, normal, radius, start_angle, end_angle)
	 ...
	 * @min_version SketchUp 6.0
	 */
	DEFINE_WRAPPED_METHOD(RubyUtils::Enumerable<Sketchup::Edge>, add_arc, (Geom::Point3d center, Geom::Vector3d xaxis, Geom::Vector3d normal, double radius, double start_angle, double end_angle, long long num_segments), add_arc, center, xaxis, normal, radius, start_angle, end_angle, num_segments)
	 ...
	 * @min_version SketchUp 6.0
	 */
	DEFINE_WRAPPED_METHOD(RubyUtils::Enumerable<Sketchup::Edge>, add_circle, (Geom::Point3d center, Geom::Vector3d normal, double radius, long long numsegs), add_circle, center, normal, radius, numsegs)
	 ...
	 * @min_version SketchUp 6.0
	 */
	DEFINE_WRAPPED_METHOD(Sketchup::ConstructionLine, add_cline, (Geom::Point3d point, Geom::Vector3d vector, std::string stipple), add_cline, point, vector, stipple)
	 ...
	 * @min_version
	 */
	DEFINE_WRAPPED_METHOD(Sketchup::ConstructionLine, add_cline, (Geom::Point3d start_point, Geom::Point3d end_point, std::string stipple), add_cline, start_point, end_point, stipple)
	 ...
	 * @min_version SketchUp 6.0
	 */
	DEFINE_WRAPPED_METHOD(Sketchup::ConstructionPoint, add_cpoint, (Geom::Point3d point), add_cpoint, point)
	 ...
	 * @min_version SketchUp 6.0
	 */
	template<typename... Ts, typename = typename std::enable_if<(std::is_base_of<Geom::Point3d, Ts>::value && ...)>::type>
	DEFINE_WRAPPED_METHOD(RubyUtils::Enumerable<Sketchup::Edge>, add_curve, (Ts... points), add_curve, points...)
	 ...
	 * @min_version
	 */
	DEFINE_WRAPPED_METHOD(RubyUtils::Enumerable<Sketchup::Edge>, add_curve, (RubyUtils::Enumerable<Geom::Point3d> points), add_curve, points)
	 ...
	 * @min_version
	 */
	DEFINE_WRAPPED_METHOD(Sketchup::DimensionLinear, add_dimension_linear, (RubyUtils::any_of<Geom::Point3d, Sketchup::Entity> start_pt_or_entity, RubyUtils::any_of<Geom::Point3d, Sketchup::Entity> end_pt_or_entity, Geom::Vector3d offset_vector), add_dimension_linear, start_pt_or_entity, end_pt_or_entity, offset_vector)
	 ...
	 * @min_version SketchUp 2014
	 */
	DEFINE_WRAPPED_METHOD(Sketchup::DimensionRadial, add_dimension_radial, (Sketchup::ArcCurve arc_curve, Geom::Point3d leader_break_pt), add_dimension_radial, arc_curve, leader_break_pt)
	 ...
	 */
	template<typename... Ts, typename = typename std::enable_if<(std::is_base_of<Geom::Point3d, Ts>::value && ...)>::type>
	DEFINE_WRAPPED_METHOD(RubyUtils::Enumerable<Sketchup::Edge>, add_edges, (Ts... points), add_edges, points...)
	 ...
	 * @min_version
	 */
	DEFINE_WRAPPED_METHOD(RubyUtils::Enumerable<Sketchup::Edge>, add_edges, (RubyUtils::Enumerable<Geom::Point3d> points), add_edges, points)
	 ...
	 * @min_version SketchUp 6.0
	 */
	template<typename... Ts, typename = typename std::enable_if<(std::is_base_of<RubyUtils::Enumerable<RubyUtils::any_of<RubyUtils::Enumerable<Sketchup::Edge>, RubyUtils::Enumerable<Geom::Point3d>>>, Ts>::value && ...)>::type>
	DEFINE_WRAPPED_METHOD(RubyUtils::optional<Sketchup::Face>, add_face, (Ts... entities), add_face, entities...)
	 ...
	 * @min_version
	 */
	DEFINE_WRAPPED_METHOD(RubyUtils::optional<Sketchup::Face>, add_face, (RubyUtils::Enumerable<RubyUtils::any_of<RubyUtils::Enumerable<Sketchup::Edge>, RubyUtils::Enumerable<Geom::Point3d>, Sketchup::Curv>> entities), add_face, entities)
	 ...
	 * @min_version SketchUp 6.0
	 */
	DEFINE_WRAPPED_METHOD(long long, add_faces_from_mesh, (Geom::PolygonMesh polygon_mesh, long long smooth_flags = Geom::PolygonMesh::AUTO_SOFTEN|Geom::PolygonMesh::SMOOTH_SOFT_EDGES, RubyUtils::any_of<Sketchup::Material, std::string> f_material = Qnil, RubyUtils::any_of<Sketchup::Material, std::string> b_material = Qnil), add_faces_from_mesh, polygon_mesh, smooth_flags, f_material, b_material)
	 ...
	 * @min_version SketchUp 6.0
	 */
	template<typename... Ts, typename = typename std::enable_if<(std::is_base_of<Sketchup::Entity, Ts>::value && ...)>::type>
	DEFINE_WRAPPED_METHOD(Sketchup::Group, add_group, (Ts... entities), add_group, entities...)
	 ...
	 * @min_version
	 */
	DEFINE_WRAPPED_METHOD(Sketchup::Group, add_group, (RubyUtils::Enumerable<Sketchup::Entity> entities), add_group, entities)
	 ...
	 * @min_version SketchUp 6.0
	 */
	DEFINE_WRAPPED_METHOD(RubyUtils::optional<Sketchup::Image>, add_image, (std::string path, Geom::Point3d point, double width, double height), add_image, path, point, width, height)
	 ...
	 * @min_version SketchUp 6.0
	 */
	DEFINE_WRAPPED_METHOD(Sketchup::ComponentInstance, add_instance, (Sketchup::ComponentDefinition definition, Geom::Transformation transform), add_instance, definition, transform)
	 ...
	 * @min_version SketchUp 6.0
	 */
	DEFINE_WRAPPED_METHOD(Sketchup::Edge, add_line, (Geom::Point3d point1, Geom::Point3d point2), add_line, point1, point2)
	 ...
	 * @min_version SketchUp 6.0
	 */
	DEFINE_WRAPPED_METHOD(RubyUtils::Enumerable<Sketchup::Edge>, add_ngon, (Geom::Point3d center, Geom::Vector3d normal, double radius, long long numsides), add_ngon, center, normal, radius, numsides)
	 ...
	 * @min_version SketchUp 6.0
	 */
	DEFINE_WRAPPED_METHOD(bool, add_observer, (Sketchup::EntitiesObserver observer), add_observer, observer)
	...
	* @min_version SketchUp 2014
	*/
	DEFINE_WRAPPED_METHOD(RubyUtils::optional<Sketchup::SectionPlane>, add_section_plane, (Geom::Point3d pt, Geom::Vector3d vec), add_section_plane, pt, vec)
	 ...
	 */
	DEFINE_WRAPPED_METHOD(Sketchup::Text, add_text, (std::string text, RubyUtils::tuple<Sketchup::InstancePath DEFINE_WRAPPED_METHOD_COMMA Geom::Point3d> instance_array_and_pt, Geom::Vector3d vector), add_text, text, instance_array_and_pt, vector)
	inline Sketchup::Text add_text(std::string text, Sketchup::InstancePath instance_array, Geom::Point3d pt, Geom::Vector3d vector)
	{
		return this->add_text(text, RubyUtils::tuple<Sketchup::InstancePath, Geom::Point3d>(instance_array, pt), vector);
	}
	 ...
	 * @min_version SketchUp 6.0
	 */
	DEFINE_WRAPPED_METHOD(RubyUtils::optional<Sketchup::Entity>, at, (long long entity_index), at, entity_index)
	 ...
	 */
	DEFINE_WRAPPED_METHOD_0(void, build, build)
	 ...
	 * @min_version SketchUp 6.0
	 */
	DEFINE_WRAPPED_METHOD_0(bool, clear, clear!)
	 ...
	 * @min_version SketchUp 6.0
	 */
	DEFINE_WRAPPED_METHOD(Sketchup::Entities&, each, (std::function<void(Sketchup::Entity)> lambda), each, lambda)
	 ...
	 */
	template<typename... Ts, typename = typename std::enable_if<(std::is_base_of<Sketchup::Entity, Ts>::value && ...)>::type>
	DEFINE_WRAPPED_METHOD(void, erase_entities, (Ts... entities), erase_entities, entities...)
	 ...
	 * @min_version
	 */
	DEFINE_WRAPPED_METHOD(void, erase_entities, (RubyUtils::Enumerable<Sketchup::Entity> entities), erase_entities, entities)
	 ...
	 * @min_version SketchUp 6.0
	 */
	DEFINE_WRAPPED_METHOD(bool, fill_from_mesh, (Geom::PolygonMesh polygon_mesh, bool weld_vertices = true, long long smooth_flags = Geom::PolygonMesh::AUTO_SOFTEN|Geom::PolygonMesh::SMOOTH_SOFT_EDGES, RubyUtils::any_of<Sketchup::Material, std::string> f_material = Qnil, RubyUtils::any_of<Sketchup::Material, std::string> b_material = Qnil), fill_from_mesh, polygon_mesh, weld_vertices, smooth_flags, f_material, b_material)
	 ...
	 * @min_version SketchUp 6.0
	 */
	DEFINE_WRAPPED_METHOD(void, intersect_with, (bool recurse, Geom::Transformation transform1, Sketchup::Entities entities1, Geom::Transformation transform2, bool hidden, RubyUtils::any_of<Sketchup::Entity, RubyUtils::Enumerable<Sketchup::Entity>> entities2), intersect_with, recurse, transform1, entities1, transform2, hidden, entities2)
	 ...
	 * @min_version SketchUp 6.0
	 */
	DEFINE_WRAPPED_METHOD(bool, remove_observer, (Sketchup::EntitiesObserver observer), remove_observer, observer)
	 ...
	 * @min_version SketchUp 6.0
	 */
	DEFINE_WRAPPED_METHOD(Sketchup::Entities, transform_by_vectors, (RubyUtils::Enumerable<Sketchup::Entity> sub_entities, RubyUtils::Enumerable<Geom::Vector3d> vectors), transform_by_vectors, sub_entities, vectors)
	 ...
	 * @min_version SketchUp 6.0
	 */
	DEFINE_WRAPPED_METHOD(bool, transform_entities, (Geom::Transformation transform, RubyUtils::Enumerable<Sketchup::Entity> entities), transform_entities, transform, entities)
	 ...
	 */
	DEFINE_WRAPPED_METHOD(RubyUtils::Enumerable<Sketchup::Curve>, weld, (RubyUtils::Enumerable<Sketchup::Edge> edges), weld, edges)
};

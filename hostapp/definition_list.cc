...
namespace HostApp
{
	...
	* @min_version 
	*/
	IMPLEMENT_WRAPPED_METHOD_RESCUED(Sketchup::DefinitionList, Sketchup::ComponentDefinition, operator[], (long long index), [], index)
	...
	* @min_version 
	*/
	IMPLEMENT_WRAPPED_METHOD(Sketchup::DefinitionList, RubyUtils::optional<Sketchup::ComponentDefinition>, operator[], (std::string name_or_guid), [], name_or_guid)
	...
	*/
	IMPLEMENT_WRAPPED_METHOD(Sketchup::DefinitionList, Sketchup::ComponentDefinition, add, (std::string def_name), add, def_name)
	...
	* @min_version SketchUp 6.0
	*/
	IMPLEMENT_WRAPPED_METHOD(Sketchup::DefinitionList, bool, add_observer, (HostApp::Sketchup::DefinitionsObserver observer), add_observer, observer)
	...
	* @min_version SketchUp 6.0
	*/
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::DefinitionList, long long, count, count)
	...
	* @min_version SketchUp 6.0
	*/
	inline Sketchup::DefinitionList& Sketchup::DefinitionList::each(std::function<void(Sketchup::ComponentDefinition)> lambda) {
		RubyUtils::Enumerable<Sketchup::ComponentDefinition>::each(lambda);
		return *this;
	}
	...
	*/
	IMPLEMENT_WRAPPED_METHOD(Sketchup::DefinitionList, Sketchup::ComponentDefinition, import, (std::string path, Hash options), import, path, options)
	...
	* @min_version SketchUp 6.0
	*/
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::DefinitionList, long long, length, length)
	...
	* @min_version 
	*/
	IMPLEMENT_WRAPPED_METHOD(Sketchup::DefinitionList, Sketchup::ComponentDefinition, load, (std::string path), load, path)
	...
	*/
	IMPLEMENT_WRAPPED_METHOD(Sketchup::DefinitionList, Sketchup::ComponentDefinition, load, (std::string path,  bool allow_newer), load, path, allow_newer)
	...
	* @min_version 
	*/
	IMPLEMENT_WRAPPED_METHOD(Sketchup::DefinitionList, Sketchup::ComponentDefinition, load_from_url, (std::string url), load_from_url, url)
	...
	*/
	IMPLEMENT_WRAPPED_METHOD(Sketchup::DefinitionList, Sketchup::ComponentDefinition, load_from_url, (std::string url, RubyUtils::details::IObject load_handler), load_from_url, url, load_handler)
	...
	* @min_version SketchUp 6.0
	*/
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::DefinitionList, Sketchup::DefinitionList, purge_unused, purge_unused)
	...
	*/
	IMPLEMENT_WRAPPED_METHOD(Sketchup::DefinitionList, bool, remove, (Sketchup::ComponentDefinition definition), remove, definition)
	...
	* @min_version SketchUp 6.0
	*/
	IMPLEMENT_WRAPPED_METHOD(Sketchup::DefinitionList, bool, remove_observer, (HostApp::Sketchup::DefinitionsObserver observer), remove_observer, observer)
	...
	*/
	IMPLEMENT_WRAPPED_METHOD_0(Sketchup::DefinitionList, long long, size, size)
	...
	* @min_version 
	*/
	IMPLEMENT_WRAPPED_METHOD(Sketchup::DefinitionList, std::string, unique_name, (std::string base_name), unique_name, base_name)
}
